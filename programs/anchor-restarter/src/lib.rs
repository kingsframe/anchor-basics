...
declare_id!("7CsExyLgAeZibmwb1r3jh2HrmkMEdqVi2knL52gofTPD");

#[program]
pub mod anchor_restarter {
    ...
    pub fn withdraw(ctx: Context<VaultAction>) -> Result<()> {
        ...
        transfer(
            CpiContext::new_with_signer(ctx.accounts.system_program.to_account_info(), Transfer {
